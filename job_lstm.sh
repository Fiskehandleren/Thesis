...
# -- end of LSF options --
bash python3 -m wandb agent latend-demand/Thesis/aso0vyhn



## bash python3 main.py --model_name LSTM --cluster WEBSTER --train_start 2019-01-01 --train_end 2019-05-01 --test_end 2019-06-01 --val_end 2019-06-20 --batch_size 32 --max_epochs 4 --dataloader EVChargersDataset --censored --loss CPNLL --censor_level 3 --accelerator gpu --devices 1
