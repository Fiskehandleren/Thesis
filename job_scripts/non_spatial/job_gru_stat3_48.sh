...
for j in 1 2 3 4
  ...
  for i in $(seq 0 "$(($n-1))")
    ...
    --model_name=GRU --num_layers=1 --accelerator=gpu  --censor_level=3 --weight_decay=0.00268538443015154 \
    --forecast_lead=48 --learning_rate=0.00070386 --inference_mode --sequence_length=336 --track_grad_norm=-1 \
