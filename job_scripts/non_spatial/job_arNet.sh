...
for j in 1 2 3 4
  ...
  for i in $(seq 0 "$(($n-1))")
    ...
    --model_name=AR --accelerator=gpu --censor_level=3 --weight_decay=0.06470644058196104 \
    --forecast_lead=1 --learning_rate=0.0005927787748490534 --inference_mode --sequence_length=336 \
    --forecast_horizon=1
  done
done