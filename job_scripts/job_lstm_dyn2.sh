...
for i in $(seq 0 "$(($n-1))")
  ...
  --batch_size=16 --covariates --dataloader=EVChargersDataset --hidden_dim=44 --max_epochs=30 \
  --model_name=LSTM --num_layers=1 --accelerator=gpu --censor_level=2 --weight_decay=0.06622145460281466 \
  --forecast_lead=1 --learning_rate=0.0005661019045297409 --censor_dynamic --inference_mode --sequence_length=336 --track_grad_norm=-1 \
