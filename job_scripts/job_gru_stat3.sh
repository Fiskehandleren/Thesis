...
for i in $(seq 0 "$(($n-1))")
  ...
  --model_name=GRU --num_layers=1 --accelerator=gpu --train_start=2017-01-01 --censor_level=3 --weight_decay=0.0013216782040014494 \
  --forecast_lead=1 --learning_rate=0.0009184290390652538 --inference_mode --sequence_length=336 --track_grad_norm=-1 \
